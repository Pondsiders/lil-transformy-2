...
Lil Transformy 2 is a language model that we think is about as small as it can be while still being interesting. [ALPHA: We'll add more to this paragraph later.]
...
Notebook 1 runs anywhere; notebook 2 wants a CUDA GPU. [ALPHA: More to come as we write 3/4.]
